...
/**
 * QualityAssuranceRunDto Class Doc Comment
 *
 * @category Class
 * @package  Memsource
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QualityAssuranceRunDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QualityAssuranceRunDto';
    ...
    protected static $swaggerTypes = [
        'initialSegment' => '\Memsource\Model\SegmentReference',
        'warningTypes' => 'string[]'
    ];
    ...
    protected static $setters = [
        'initialSegment' => 'setInitialSegment',
    ...
    {
        $this->container['initialSegment'] = isset($data['initialSegment']) ? $data['initialSegment'] : null;
     ...
     */
    public function getInitialSegment()
    {
        return $this->container['initialSegment'];
    }

    /**
     * Sets initialSegment
     *
     * @param \Memsource\Model\SegmentReference $initialSegment initialSegment
     *
     * @return $this
     */
    public function setInitialSegment($initialSegment)
    {
        $this->container['initialSegment'] = $initialSegment;
    ...
    public function setWarningTypes($warningTypes)
    {
        ...
        if (!is_null($warningTypes) && array_diff($warningTypes, $allowedValues)) {
