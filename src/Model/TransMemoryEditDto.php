...
/**
 * TransMemoryEditDto Class Doc Comment
 *
 * @category Class
 * @package  Memsource
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransMemoryEditDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransMemoryEditDto';
    ...
    {
        if ((strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TransMemoryEditDto., must be smaller than or equal to 255.');
        }
        if ((strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TransMemoryEditDto., must be bigger than or equal to 0.');
        }
     ...
     * Sets targetLangs
     *
     * @param string[] $targetLangs New target languages to add. No languages can be removed
     *
     * @return $this
     */
    ...
    public function setNote($note)
    {
        if (!is_null($note) && (strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling TransMemoryEditDto., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling TransMemoryEditDto., must be bigger than or equal to 0.');
        }
