...
/**
 * TranslationPriceSetCreateDto Class Doc Comment
 *
 * @category Class
 * @package  Memsource
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TranslationPriceSetCreateDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TranslationPriceSetCreateDto';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sourceLanguages'] === null) {
            $invalidProperties[] = "'sourceLanguages' can't be null";
        }
