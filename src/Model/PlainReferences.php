...
/**
 * PlainReferences Class Doc Comment
 *
 * @category Class
 * @package  Memsource
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PlainReferences implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PlainReferences';
    ...
    public function setTransGroupId($transGroupId)
    {
        ...
        if (($transGroupId < 0)) {
            throw new \InvalidArgumentException('invalid value for $transGroupId when calling PlainReferences., must be bigger than or equal to 0.');
        }
