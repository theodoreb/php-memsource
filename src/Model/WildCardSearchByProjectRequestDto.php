<?php
/**
 * WildCardSearchByProjectRequestDto
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * WildCardSearchByProjectRequestDto Class Doc Comment
 *
 * @category Class
 * @package  Memsource
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WildCardSearchByProjectRequestDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WildCardSearchByProjectRequestDto';
    ...
    public function setCount($count)
    {
        ...
        if (!is_null($count) && ($count > 50)) {
            throw new \InvalidArgumentException('invalid value for $count when calling WildCardSearchByProjectRequestDto., must be smaller than or equal to 50.');
        }
        if (!is_null($count) && ($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling WildCardSearchByProjectRequestDto., must be bigger than or equal to 1.');
        }
