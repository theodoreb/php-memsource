 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserEditDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserEditDto';
    ...
    public function setUserName($userName)
    {
        if ((strlen($userName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $userName when calling UserEditDto., must be smaller than or equal to 255.');
        }
        if ((strlen($userName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $userName when calling UserEditDto., must be bigger than or equal to 0.');
        }
    ...
    public function setFirstName($firstName)
    {
        if ((strlen($firstName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling UserEditDto., must be smaller than or equal to 255.');
        }
        if ((strlen($firstName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling UserEditDto., must be bigger than or equal to 0.');
        }
    ...
    public function setLastName($lastName)
    {
        if ((strlen($lastName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling UserEditDto., must be smaller than or equal to 255.');
        }
        if ((strlen($lastName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling UserEditDto., must be bigger than or equal to 0.');
        }
    ...
    {
        if ((strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserEditDto., must be smaller than or equal to 255.');
        }
        if ((strlen($email) < 0)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserEditDto., must be bigger than or equal to 0.');
        }
    ...
    public function setTimezone($timezone)
    {
        if ((strlen($timezone) > 255)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling UserEditDto., must be smaller than or equal to 255.');
        }
        if ((strlen($timezone) < 0)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling UserEditDto., must be bigger than or equal to 0.');
        }
    ...
    public function setNote($note)
    {
        if (!is_null($note) && (strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling UserEditDto., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling UserEditDto., must be bigger than or equal to 0.');
        }
