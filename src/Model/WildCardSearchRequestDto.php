...
/**
 * WildCardSearchRequestDto Class Doc Comment
 *
 * @category Class
 * @package  Memsource
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WildCardSearchRequestDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WildCardSearchRequestDto';
    ...
    public function setCount($count)
    {
        ...
        if (!is_null($count) && ($count > 50)) {
            throw new \InvalidArgumentException('invalid value for $count when calling WildCardSearchRequestDto., must be smaller than or equal to 50.');
        }
        if (!is_null($count) && ($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling WildCardSearchRequestDto., must be bigger than or equal to 1.');
        }
